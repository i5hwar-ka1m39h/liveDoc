...
export default function Collaborator({ roomId, collaborator, email, creatorId, user }: CollaboratorProps) {
    ...
    return (
        <li className=' flex items-center justify-between gap-2 py-3'>
            <div className=' flex gap-2'>
                <Image src={collaborator.avatar} alt={collaborator.name} width={36} height={36}
                    className=' size-9 rounded-full' />

                <div className=' line-clamp-1 text-sm leading-4 font-semibold text-white'>
                    <p>{collaborator.name}
